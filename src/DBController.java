...
public class DBController {
    ...
    public static void createUserDBSchema(){
        Connection conn =  connectToDB();
        try {
            Statement st = conn.createStatement();
    ...
    // Find solution for dateOfBirth Date Format
    ...
    public static Boolean findUsernameInDB(String username){
        Connection conn = connectToDB();
        try{
            Statement st = conn.createStatement();
    ...
    public static String findPasswordInDB(String password){
        Connection conn = connectToDB();
        try{
            Statement st = conn.createStatement();
            ResultSet result =  st.executeQuery("SELECT user_password FROM USER WHERE user_password ='" + password + "'");
            result.next();
